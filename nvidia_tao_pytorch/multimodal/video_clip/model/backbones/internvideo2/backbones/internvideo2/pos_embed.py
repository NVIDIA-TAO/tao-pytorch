...
"""Sin-cos position-embedding construction and checkpoint interpolation helpers."""
import numpy as np
import torch
import logging
...
def get_2d_sincos_pos_embed_from_grid(embed_dim, grid):
    """Build a 2D sin-cos position embedding from a coordinate grid."""
...
def interpolate_pos_embed(checkpoint_model, model, orig_t_size=4, pos_name='vision_encoder.pos_embed'):
    """Interpolate a checkpoint's position embedding to the model's grid size."""
...
def interpolate_pos_embed_internvideo2(checkpoint_model, model, orig_t_size=8):
    ...
    """Interpolate InternVideo2 position embeddings to the model's temporal size."""
...
def interpolate_pos_embed_internvideo2_new(checkpoint_model, model, orig_t_size=8):
    """Interpolate every InternVideo2 position-embedding tensor in a checkpoint."""
    pos_names = []
