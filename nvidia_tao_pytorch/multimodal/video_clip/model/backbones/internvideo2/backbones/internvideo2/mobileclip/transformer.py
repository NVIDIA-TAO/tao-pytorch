...
class LayerNormFP32(nn.LayerNorm):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        """Apply layer normalization in fp32 and cast back to the input dtype."""
        inp_dtype = x.dtype
        return super().forward(x.to(torch.float32)).to(inp_dtype)


def get_normalization_layer(norm_type, num_features):
    """Build the normalization layer named by norm_type."""
...
class PositionalEmbedding(nn.Module):
    """Positional embedding wrapper selecting a learnable or fixed table."""
    ...
    def forward(self, seq_len: int, *args, **kwargs) -> Tensor:
        """Return the positional embedding for the first seq_len positions."""
        return self.pos_embed(seq_len, *args, **kwargs)

    def __repr__(self):
        """Return the wrapped embedding's representation."""
...
class LearnablePositionalEmbedding(nn.Module):
    ...
    def reset_parameters(self) -> None:
        """Re-initialize the embedding table, zeroing the padding index."""
    ...
    def __repr__(self):
        """Return a string describing the embedding shape and padding index."""
...
class MultiHeadAttention(nn.Module):
    ...
    def __repr__(self):
        """Return a string describing the attention head configuration."""
    ...
    def _forward_impl(
        ...
        batch_size, _, num_src_tokens, num_tgt_tokens = attn.shape
    ...
    def forward(  # pylint: disable=keyword-arg-before-vararg
        self,
        x_q: Tensor,
        x_kv: Optional[Tensor] = None,
        key_padding_mask: Optional[Tensor] = None,
        ...
        **kwargs,
        ...
        """Run multi-head attention over the query and optional key/value tensors."""
...
class TransformerEncoder(nn.Module):
    ...
    def __repr__(self) -> str:
        """Return a string describing the encoder-layer configuration."""
    ...
    def forward(  # pylint: disable=keyword-arg-before-vararg
        ...
        **kwargs,
        ...
        """Run the self-attention and feed-forward residual branches."""
        res = x
