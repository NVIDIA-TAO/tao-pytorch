...
class RetrievalMetrics:
    ...
    Attributes:
        ...
        hit_at_k: Dictionary mapping k values to any-hit recall
            (1.0 if >=1 relevant item is in top-k). For 1:1 GT this equals
            recall_at_k; for N-to-N it is the standard retrieval recall@k.
    ...
    def __str__(self) -> str:
        ...
        for k in sorted(self.hit_at_k.keys()):
...
class RetrievalEvaluator:
    ...
    def evaluate(
        ...
        return RetrievalMetrics(
            ...
            hit_at_k={k: np.mean(v) for k, v in hit_scores.items() if v},
