...
Functions:
    ...
    build_internvideo2clip_model: Build InternVideo2-CLIP model
"""
...
from nvidia_tao_pytorch.multimodal.video_clip.model.adapters.radio import CRADIO
from nvidia_tao_pytorch.multimodal.video_clip.model.adapters.siglip2 import SigLIP2
from nvidia_tao_pytorch.multimodal.video_clip.model.adapters.openclip import OpenCLIP
from nvidia_tao_pytorch.multimodal.video_clip.model.adapters.internvideo2clip import (
    InternVideo2CLIP,
    InternVideo2FrameTransform,
)
from nvidia_tao_pytorch.multimodal.video_clip.model.transforms import (
...
def build_internvideo2clip_model(
    model_cfg,
    ...
    model = InternVideo2CLIP(
        internvideo2clip_hf_id=model_cfg.internvideo2clip_hf_id,
        vision_encoder=model_cfg.vision_encoder,
        text_encoder=model_cfg.text_encoder,
        clip_head=model_cfg.clip_head,
